...
const verticals = [
  {
    ...
    description: "Track competitor pricing, promotions, and product launches across online and local stores.",
    icon: (
  ...
  },
  {
    ...
    description: "Monitor Google Maps reviews, menu pricing, and local reputation across locations.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Watch how competitors position their services, pricing models, and client testimonials.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Track patient reviews, practice reputation, and how competitors market their services.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Compare vehicle pricing, lease offers, and dealership reviews across your market.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Monitor competitor reviews, pricing, and how they show up in local search results.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <section className="bg-cream-dark px-6 py-20 lg:px-8">
      <div ref={ref} className="mx-auto max-w-4xl">
        <h2 className="text-center font-heading text-2xl md:text-3xl">
          Built for Local and Regional Businesses
        </h2>
        <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-text-muted md:text-base">
          Whether you run one location or fifty, claudje tracks the competitors
