...
export default function AgentArchitecture() {
  ...
  const t = messages.agentArchitecture;
      ...
      <div ref={ref} className="mx-auto max-w-5xl">
        ...
        >
          ...
          <div className={cardNormal} style={{ transitionDelay: "0ms" }}>
            ...
            <p className="mt-1 text-xs font-semibold text-text-primary">{t.competitorsLabel}</p>
            <p className="text-[10px] text-text-muted">{t.competitorsSub}</p>
          </div>
          ...
          <div className={cardGold} style={{ transitionDelay: "100ms" }}>
            ...
            <p className="mt-1 text-xs font-semibold text-gold-dark">{t.agentLabel}</p>
            <p className="text-[10px] text-text-muted">{t.agentSub}</p>
          </div>
          ...
          <div className="flex flex-col gap-2" style={{ transitionDelay: "200ms" }}>
            <div className={cardSource}>
              <p className="text-xs font-semibold text-text-primary">{t.dataSourcesLabel}</p>
              <p className="text-[10px] text-text-muted">{t.dataSourcesSub}</p>
            </div>
            <div className={cardSource}>
              <p className="text-xs font-semibold text-text-primary">{t.webAiLabel}</p>
              <p className="text-[10px] text-text-muted">{t.webAiSub}</p>
            </div>
          </div>
          ...
          <div className={cardNormal} style={{ transitionDelay: "300ms" }}>
            ...
            <p className="mt-1 text-xs font-semibold text-text-primary">{t.reportLabel}</p>
            <p className="text-[10px] text-text-muted">{t.reportSub}</p>
          </div>
          ...
          <div className={cardGold} style={{ transitionDelay: "400ms" }}>
            ...
            <p className="mt-1 text-xs font-semibold text-gold-dark">{t.humanReviewLabel}</p>
            <p className="text-[10px] text-text-muted">{t.humanReviewSub}</p>
          </div>
          ...
          <div className={cardGold} style={{ transitionDelay: "500ms" }}>
            ...
            <p className="mt-1 text-xs font-semibold text-gold-dark">{t.finalReportLabel}</p>
            <p className="text-[10px] text-text-muted">{t.finalReportSub}</p>
          </div>
        </div>
        ...
        >
          <div className={cardNormal}>
            <p className="text-xs font-semibold">{t.competitorsLabel}</p>
            <p className="text-[10px] text-text-muted">{t.competitorsSub}</p>
          </div>
          {arrow}
          ...
          <div className="flex gap-2">
            <div className={cardSource}>
              <p className="text-[11px] font-semibold">{t.dataSourcesLabel}</p>
            </div>
            <div className={cardSource}>
              <p className="text-[11px] font-semibold">{t.webAiLabel}</p>
            </div>
          </div>
          {arrow}
          <div className={cardNormal}>
            <p className="text-xs font-semibold">{t.reportSynthesisLabel}</p>
          </div>
          {arrow}
          <div className={cardGold}>
            <p className="text-xs font-semibold text-gold-dark">{t.humanReviewLabel}</p>
          </div>
          {arrow}
          <div className={cardGold}>
            <p className="text-xs font-semibold text-gold-dark">{t.finalReportLabel}</p>
            <p className="text-[10px] text-text-muted">{t.finalReportSub}</p>
          </div>
        </div>
      </div>
