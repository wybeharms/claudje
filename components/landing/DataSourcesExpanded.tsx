...
const sources = [
  ...
  {
    name: "Trustpilot",
    description: "Customer sentiment, rating trends, and complaint themes.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
  ...
  },
  {
    ...
    description: "Registration changes, director updates, and legal filings.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
  ...
  {
    name: "G2",
    description: "Software ratings, feature comparisons, and buyer sentiment.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
  ...
  {
    name: "Glassdoor",
    description: "Employee ratings, hiring trends, and company culture signals.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
  ...
  {
    name: "SEO tools",
    description: "Keyword rankings, backlink changes, and organic visibility.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
    ...
    <section className="bg-cream px-6 py-20 lg:px-8">
      <div ref={ref} className="mx-auto max-w-4xl">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-text-muted md:text-base">
          Your agents pull verified data from professional tools and platforms.
          Not web scraping. Real API access.
        </p>
