const steps = [
  {
    ...
    description: (
      <>
        List up to 5, 10, or 15 competitors.
        <br />
        Any industry.
      </>
    ),
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 flex items-center justify-center gap-3 rounded-xl bg-gold/20 px-6 py-4">
          ...
          <p className="text-sm text-text-muted">
            Every report is <span className="font-medium text-brown">reviewed by an analyst</span> before delivery. AI does the heavy lifting, we ensure quality.
          </p>
        </div>
      </div>
    </section>
