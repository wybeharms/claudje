...
export const messages: Messages = {
  ...
  whyClaudje: {
    ...
    fakePricing:
      "Their pricing isn\u2019t publicly listed, but based on similar companies, I\u2019d estimate they charge around \u00A340-90 per month.",
    fakeDisclaimer:
    ...
    pricingItemRest: " raised prices by 12% on 15 March.",
  ...
  reportPreview: {
    ...
    subtitle:
      "Every report is fully customisable to your business. Here's what a typical report looks like.",
    ...
    items: [
      {
        ...
        answer:
          "claudje uses AI to analyse publicly available information: websites, pricing pages, review platforms, company registries, social media profiles, and search trends. No scraping of private data, no hacking. Just structured analysis of what's already out there.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Absolutely. claudje only analyses publicly available information \u2014 the same data anyone could find by visiting your competitors' websites, reading their reviews, or checking Companies House. We just do it systematically and deliver the insights to you.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "claudje uses the same AI models as ChatGPT and Claude, but deploys a team of specialised sub-agents with their own skills and paid tool access. Each agent handles a different part of the research: Google Maps reviews, Companies House filings, LinkedIn activity, and more. A chatbot summarises the first page of Google.\n\nclaudje cross-references real data from multiple sources into one complete report.",
      },
      {
  ...
  technology: {
    ...
    heroBody:
      "Behind every report is a team of specialised AI agents. Each one trained for a specific research task. Supervised by a human analyst.",
  ...
  about: {
    ...
    mission:
      "Agentic AI took the world by storm at the end of 2025. That same technology is now rapidly expanding into everyday business processes. claudje is built to capitalise on this shift, delivering managed competitor intelligence powered by the best AI agents available.",
    cta: "Get Started",
  ...
  comparisonTable: {
    ...
    rows: {
      ...
      sources: {
        ...
        claudje: "Companies House, Trustpilot, Meta Ads, Firecrawl",
      },
      verification: {
      ...
      tracking: {
        ...
        claudje: "Continuous, week-on-week",
      },
      count: {
  ...
  useCases: {
    ...
    verticals: {
      retail: {
        ...
        description:
          "Track competitor pricing, promotions, and product launches across online and local shops.",
      },
      hospitality: {
  ...
  reportFragments: {
    ...
    ads: {
      ...
      insight:
        "7 of 10 competitors run zero paid ads. The field is nearly empty \u2014 each pound of your ad-spend stretches exceptionally far.",
    },
    ai: {
    ...
    recommendations: {
      ...
      insight:
        "Every report closes with 2\u20134 concrete actions, prioritised by cost and timing.",
      quickWinKind: "Quick win",
      quickWinTitle: "Launch a Meta ad on your entry price",
      quickWinBody:
        "Your A-segment is now the cheapest in the market. A single campaign targeting that gap costs under \u00A3200/week and capitalises on Competitor 01\u2019s recent price hike.",
  ...
  agentRoster: {
    ...
    subtitle:
      "Eight specialised agents, each trained for a specific research task. They work in parallel, covering every angle of your competitive landscape.",
    agents: {
      website: {
      ...
      filings: {
        name: "Public Filings",
        description:
          "Pulls Companies House registrations and flags legal or director changes.",
      },
      search: {
